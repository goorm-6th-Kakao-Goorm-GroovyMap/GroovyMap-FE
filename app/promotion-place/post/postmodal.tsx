...
const Modal: React.FC<ModalProps> = ({ show, onClose, post, liked, saved, setLiked, setSaved }) => {
    ...
    const handleLikeClick = async () => {
        ...
        setLiked(newLiked); // 상위 컴포넌트의 상태 변경 함수 호출
        ...
        try {
            ...
            setLikesCount(newLiked ? likesCount - 1 : likesCount + 1);
            setLiked(!newLiked); // 오류 발생 시 상태 롤백
        }
    };
    ...
    const handleSaveClick = async () => {
        ...
        setSaved(newSaved); // 상위 컴포넌트의 상태 변경 함수 호출
        ...
        try {
            ...
            setSavesCount(newSaved ? savesCount - 1 : savesCount + 1);
            setSaved(!newSaved); // 오류 발생 시 상태 롤백
        }
    };
